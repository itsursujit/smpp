...
object WritePdu {
  ...
  trait BindWriter extends PduWriter {
    this: BindLike =>
  ...
  trait BindRespWriter extends PduWriter {
    this: BindRespLike =>
    def writeBody(bsb: ByteStringBuilder) = {
  ...
  trait OutbindWriter extends PduWriter {
    this: Outbind =>
    def writeBody(bsb: ByteStringBuilder) = {
      bsb.putCOctetString(systemId)
      bsb.putCOctetString(password)
  ...
  trait HeaderOnlyWriter extends PduWriter {
    this: Pdu =>
    def writeBody(bsb: ByteStringBuilder) = bsb.result()
  }

  trait SmWriter extends PduWriter {
    this: SmLike =>
    def writeBody(bsb: ByteStringBuilder) = {
  ...
  trait SmRespWriter extends PduWriter {
    this: SmRespLike =>
    def writeBody(bsb: ByteStringBuilder) = {
  ...
  trait SubmitMultiWriter extends PduWriter {
    this: SubmitMulti =>
    def writeBody(bsb: ByteStringBuilder) = {
      bsb.putServiceType(serviceType)
      bsb.putTypeOfNumber(sourceAddrTon)
  ...
  trait SubmitMultiRespWriter extends PduWriter {
    this: SubmitMultiResp =>
    def writeBody(bsb: ByteStringBuilder) = {
  ...
  trait DataSmWriter extends PduWriter {
    this: DataSm =>
    def writeBody(bsb: ByteStringBuilder) = {
      bsb.putServiceType(serviceType)
      bsb.putTypeOfNumber(sourceAddrTon)
  ...
  trait DataSmRespWriter extends PduWriter {
    this: DataSmResp =>
    def writeBody(bsb: ByteStringBuilder) = {
      bsb.putCOctetString(messageId)
      for (tlv <- tlvs) {
  ...
  trait QuerySmWriter extends PduWriter {
    this: QuerySm =>
    def writeBody(bsb: ByteStringBuilder) = {
      bsb.putCOctetString(messageId)
      bsb.putTypeOfNumber(sourceAddrTon)
  ...
  trait QuerySmRespWriter extends PduWriter {
    this: QuerySmResp =>
    def writeBody(bsb: ByteStringBuilder) = {
      bsb.putCOctetString(messageId)
  ...
  trait CancelSmWriter extends PduWriter {
    this: CancelSm =>
    def writeBody(bsb: ByteStringBuilder) = {
      bsb.putServiceType(serviceType)
      bsb.putCOctetString(messageId)
  ...
  trait ReplaceSmWriter extends PduWriter {
    this: ReplaceSm =>
    def writeBody(bsb: ByteStringBuilder) = {
      bsb.putCOctetString(messageId)
      bsb.putTypeOfNumber(sourceAddrTon)
  ...
  trait AlertNotificationWriter extends PduWriter {
