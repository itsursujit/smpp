...
import smpp.actors.SmppServer._
import smpp.extensions.Smpp
import smpp.extensions.Smpp.{IncomingConnection, ServerBinding}
import smpp.protocol.SmppTypes.SequenceNumber
import smpp.protocol._
import smpp.protocol.auth.{BindAuthenticator, BindRequest, BindResponseError, BindResponseSuccess}
...
object SmppServer {
  ...
  case class ReadyIncomingSmppConnection(connection: ActorRef, addr: InetSocketAddress)
